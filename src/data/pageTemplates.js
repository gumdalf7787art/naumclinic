  ...
  'pain/spine': [
    {
      ...
      "data": {
        "title": "목·허리 척추 클리닉",
        "slogan": "지긋지긋한 목·허리 통증,\n근본 원인을 바로잡습니다.",
        "paragraphs": [
          "현대인의 고질병인 거북목 증후군부터 목/허리 디스크, 척추관 협착증까지.\n수술에 대한 부담 없이 안전하고 효과적인 비수술적 요법으로 척추의 자생력을 회복시킵니다."
        ]
      }
    },
    {
      ...
      "data": {
        "title": "주요 치료법",
        "values": [
          { "num": "01", "title": "비수술 주사치료", "desc": "초음파 및 C-arm 유도하에 병변 부위에 정확하게 약물을 투여하여 염증을 제거합니다.", "icon": "Activity" },
          { "num": "02", "title": "도수치료", "desc": "숙련된 치료사가 틀어진 척추와 관절을 교정하여 기능을 회복시킵니다.", "icon": "Users" },
          { "num": "03", "title": "무중력 감압치료", "desc": "디스크 내부 압력을 낮추어 밀려난 디스크가 제자리로 돌아가도록 돕습니다.", "icon": "Shield" }
        ]
      }
    }
  ],
