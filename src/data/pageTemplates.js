  ...
  'rehab/post-op': [
    ...
    },
    {
      ...
      "data": {
        "title": "단계별 안심 회복 시스템",
        "stages": [
          { "title": "통증 조절기", "desc": "염증 및 붓기를 완화하고, 수술 부위 조직의 치유를 촉진하며 가벼운 수동적 관절 운동(CPM 등)을 시행합니다." },
          { "title": "가동 범위 회복기", "desc": "부드러운 스트레칭과 능동 보조 운동을 통해 굳어진 관절의 가동 범위(ROM)를 정상 수준까지 확대합니다." },
          { "title": "근력 강화기", "desc": "수술 부위 및 주변 약해진 근육을 집중적으로 단련하고, 점진적인 체중 부하 및 밸런스 훈련을 진행합니다." },
          { "title": "일상 / 스포츠 복귀기", "desc": "고유수용성 감각 훈련과 실전 동작 훈련을 통해 안전하게 일상생활이나 스포츠 활동으로 복귀합니다." }
        ]
      }
    },
    {
